      ...
      >
        <div className={modalClasses.paper}>
          ...
          <List className={modalClasses.list}>
            <ListItem> <ListItemText primary="Photos" secondary="Jan 9, 2014" /> :{movieDetails.id}</ListItem>
            <ListItem>TITLE :{movieDetails.Title}</ListItem>
            <ListItem>TITLE :{movieDetails.ReleaseYear}</ListItem>
            <ListItem>TITLE : {movieDetails.Stars}</ListItem>
          </List>
        </div>
      </Modal>
